...
declare const AccessControlApplication_base: (new (...args: any[]) => {
    ...
    mountComponentServices<T_2_1 extends import("@loopback/core").Component = import("@loopback/core").Component>(component: import("@loopback/core").Constructor<T_2_1>, componentBindingKey?: string | BindingKey<T_2_1> | undefined): void;
    readonly options: ApplicationConfig;
    readonly state: string;
